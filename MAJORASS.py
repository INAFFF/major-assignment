...
d1 = st.date_input("start date", datetime.date(2019, 1, 1), datetime.date(1900, 1, 1), datetime.date(2100, 12, 31))
st.write("Start Date: ", d1)

d2 = st.date_input("end date", datetime.date(2020, 1, 1), datetime.date(1900, 1, 1), datetime.date(2100, 12, 31))
